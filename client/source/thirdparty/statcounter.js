export default (sc_project, sc_security) => {
    ...
    function _sc_strip_tags(_1, _2) {
        _2 = (
            ((_2 || '') + '').toLowerCase().match(/<[a-z][a-z0-9]*>/g) || []
        ).join('')
        ...
        if (_f(_e, 'tags') && typeof _e.tags === 'object') {
            ...
            if (_sc_validateTags(_16)) {
                ...
                for (i = 0; i < _16.length; i = i + 2) {
                    _15 +=
                        '&sc_ev_' +
                        encodeURIComponent(_16[i]) +
                        '=' +
                        encodeURIComponent(_16[i + 1])
                }
            }
        }
        return _15
    ...
    var sc_doc_loc = '' + document.location
    var myRE = new RegExp('^https', 'i')
    ...
    if (window.sc_remove_link) {
        ...
        sc_link_back_start =
            '<a class="statcounter" href="http://www.' +
            sc_host +
            '" target="_blank">'
        sc_link_back_end = '</a>'
    }
    ...
    var sc_time_difference = 3600000
    var sc_title = '' + document.title
    var sc_url = '' + document.location
    var sc_title = sc_title.substring(0, 300)
    var sc_url = sc_url.substring(0, 300)
    ...
    var _sc_apply_mar_2017_fixes =
        _sc_project_int == 4124138 ||
        _sc_project_int == 204609 ||
        _sc_project_int > 11200000
    ;(function(_25, _26, _27, _28) {
        ...
        try {
            ...
            function mixkey(_5d, key) {
                ...
                while (j < _5f.length) {
                    key[_43 & j] =
                        _43 & ((_60 ^= key[_43 & j] * 19) + _5f.charCodeAt(j++))
                }
                return tostring(key)
            }
            ...
            function detectBrowserFeatures() {
                ...
                var _85 = new RegExp('Mac OS X.*Safari/').test(navigator.userAgent)
            ...
            if (sc_sp != 'disabled') {
                ...
                try {
                    ...
                    if (!_sc_apply_mar_2017_fixes) {
                        if (
                            _91 == 'r' &&
                            sessionStorage.getItem('statcounter_exit_domain') == _90
                        ) {
                            _90 = 'internal'
                        }
                    }
            ...
            if (_3f) {
                ...
                _9d.src =
                    ...
                    sc_project +
                    '&fake_post&user_company&feedback=consistent%20uniques%20js%20exception:%20' +
                    encodeURIComponent(_b4)
            }
            sc_unique_returning = ''
            sc_uuid_q = '&u1=f2'
        }
        if (
            Object.prototype.toString.call(_statcounter_pending) ===
            '[object Array]'
        ) {
        ...
        var _b7 =
            ...
            sc_height +
            '&camefrom=' +
            escape(sc_referer.substring(0, 600)) +
            '&u=' +
            sc_url +
            '&t=' +
            sc_title +
                    ...
                    try {
                        ...
                        if (_3f) {
                            ...
                            _cf.src =
                                ...
                                encodeURIComponent(_cd)
                        }
                    }
                }
                if (!_b8 || !_b9) {
                    _sc_imgs[sc_call] = new Image()
                    _sc_imgs[sc_call].src =
                        sc_base_dir + '&sc_random=' + Math.random() + _b7
                }
            } else {
                var _d0 =
                    sc_base_dir +
    ...
    if (sc_cls > 0) {
        if (clickstat_done != 1) {
            ...
            domain = host_split + '.' + domain
            var lnklocal_mask =
                '^https?://(.*)(' + domain + '|webcache.googleusercontent.com)'
            ...
            if (document.getElementsByTagName) {
                ...
                for (var i = 0; i < anchors.length; i++) {
                    ...
                    if (anchor.onmousedown) {
                        ...
                        anchor.onmousedown = new Function(
                            'event',
                            "sc_clickstat_call(this,'" +
                                sc_click_dir +
                                "');return true;",
                        )
                    }
                        ...
                        if (lnklocal.test(_d4)) {
                            if (dl.test(_d4)) {
                                ...
                                if (
                                    ...
                                    new RegExp(sc_exit_link_detect, 'i').test(_d4)
                                ) {
                                    _d6 = 2
                                } else {
                                    if (sc_cls == 2) {
            ...
            function sc_adsense_click(_da) {
                if (_da.src.match(sc_gsyn_pattern)) {
                    ...
                    var _db = escape(
                        'Google Adsense ' + _da.width + 'x' + _da.height,
                    )
                }
                var i = new Image()
                var _dd =
            ...
            function sc_adsense_init() {
                if (document.all && typeof window.opera == 'undefined') {
                    ...
                    for (var i = 0; i < el.length; i++) {
                        if (
                            el[i].src.match(sc_gsyn_pattern) ||
                            el[i].id.match(sc_gsyn_pattern2)
                        ) {
            ...
            function sc_exitpage(e) {
                ...
                for (var i = 0; i < ad.length; i++) {
                    ...
                    if (_ec && _eb) {
                        if (
                            ad[i].src.match(sc_gsyn_pattern) ||
                            ad[i].id.match(sc_gsyn_pattern2)
                        ) {
